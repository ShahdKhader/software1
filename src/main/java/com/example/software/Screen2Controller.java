...
public class Screen2Controller implements Initializable {
    ...
    @FXML
    public TextField colorscreen2,sizescreen2,quantityscreen2,namescreen2;
    @FXML
    private String temp;
    @FXML
    ...
    void saveClicked(ActionEvent event) {
        if(TESTINPUT.ordernameTest(namescreen2.getText())==0) JOptionPane.showMessageDialog(null,"Unvalied name","ERROR",JOptionPane.ERROR_MESSAGE);
            ...
            database.insertIntoDatabase("insert into PRODUCT values('"+"4"+"','"+ "407963852"+"','"+"407123456"+ "','"+namescreen2.getText()+"','" +quantityscreen2.getText()+"','"+sizescreen2.getText()+"','"+colorscreen2.getText()+"','"+"working"+"','"+"200"+"')");
